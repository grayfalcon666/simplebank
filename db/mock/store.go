...
// ListAccouts mocks base method.
func (m *MockStore) ListAccouts(ctx context.Context, arg db.ListAccoutsParams) ([]db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListAccouts", ctx, arg)
	ret0, _ := ret[0].([]db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListAccouts indicates an expected call of ListAccouts.
func (mr *MockStoreMockRecorder) ListAccouts(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAccouts", reflect.TypeOf((*MockStore)(nil).ListAccouts), ctx, arg)
}
...
func (m *MockStore) ListTransfersByFromAccount(ctx context.Context, arg db.ListTransfersByFromAccountParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) ListTransfersByFromAccount(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockStore) ListTransfersByToAccount(ctx context.Context, arg db.ListTransfersByToAccountParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) ListTransfersByToAccount(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
